...
export const adminCopy: Record<Locale, AdminCopy> = {
  fr: {
    ...
    access: {
      ...
      retry: 'Réessayer', backHome: 'Retour à l’accueil', backToApp: 'Retour à Lewad', checking: 'Vérification de votre espace…',
    },
    header: {
      product: 'Lewad Admin', admin: 'Admin', superAdmin: 'Super Admin', subtitle: 'Vue sécurisée des opérations Lewad', userSpace: 'Voir l’espace utilisateur',
    ...
    sidebar: {
      ...
      userNavigation: 'Espace utilisateur', userSpace: 'Espace utilisateur', search: 'Recherche', profile: 'Profil', credits: 'Mes crédits', recharge: 'Recharger', settings: 'Paramètres', contact: 'Contact',
    },
    users: {
  ...
  ar: {
    ...
    access: {
      ...
      retry: 'إعادة المحاولة', backHome: 'العودة إلى الرئيسية', backToApp: 'العودة إلى لواد', checking: 'جارٍ التحقق من مساحتك…',
    },
    header: {
      product: 'إدارة لواد', admin: 'مشرف', superAdmin: 'مشرف عام', subtitle: 'عرض آمن لعمليات لواد', userSpace: 'عرض مساحة المستخدم',
    ...
    sidebar: {
      ...
      userNavigation: 'مساحة المستخدم', userSpace: 'مساحة المستخدم', search: 'البحث', profile: 'الملف الشخصي', credits: 'نقاطي', recharge: 'شحن', settings: 'الإعدادات', contact: 'التواصل',
    },
    users: {
  ...
  en: {
    ...
    access: {
      ...
      retry: 'Try again', backHome: 'Back to home', backToApp: 'Back to Lewad', checking: 'Checking your space…',
    },
    header: {
      product: 'Lewad Admin', admin: 'Admin', superAdmin: 'Super Admin', subtitle: 'Secure view of Lewad operations', userSpace: 'View user space',
    ...
    sidebar: {
      ...
      userNavigation: 'User space', userSpace: 'User space', search: 'Search', profile: 'Profile', credits: 'My credits', recharge: 'Recharge', settings: 'Settings', contact: 'Contact',
    },
    users: {
