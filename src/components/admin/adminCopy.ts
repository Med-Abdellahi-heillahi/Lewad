...
export const adminCopy: Record<Locale, AdminCopy> = {
  ...
  ar: {
    ...
    access: {
      ...
      retry: 'إعادة المحاولة', backHome: 'العودة إلى الرئيسية', backToApp: 'العودة إلى Lewad', checking: 'جارٍ التحقق من مساحتك…', redirecting: 'جارٍ تحويلك إلى مساحتك…',
    },
    header: {
      product: 'مساحة الإدارة', admin: 'مشرف', superAdmin: 'مشرف عام', subtitle: 'عرض آمن لعمليات Lewad', userSpace: 'عرض مساحة المستخدم',
    ...
    users: {
      title: 'المستخدمون', subtitle: 'أدر حسابات مستخدمي Lewad وأدوارهم وحالاتهم.',
    ...
    credits: {
      ...
      reportTitle: 'تقرير عمليات البحث في Lewad', reportGenerated: 'أُنشئ في',
    },
    requests: {
      ...
      detailsTitle: 'تفاصيل الطلب', noteTitle: 'ملاحظة داخلية', noteSubtitle: 'مرئية لفريق Lewad فقط.', notePreview: 'ملاحظة', noNote: 'لا توجد ملاحظة',
    ...
    businessSubmissions: {
      ...
      approveConfirmText: 'سيتم إنشاء المؤسسة والوكالة الرئيسية. ستظهر المؤسسة في نتائج بحث Lewad.',
    ...
    establishmentForm: {
      ...
      createdTitle: 'تمت إضافة الخدمة بنجاح', createdText: 'أصبحت البطاقة ووكالتها الرئيسية متاحتين الآن على Lewad.',
      creationFailed: 'تعذر إضافة هذه الخدمة.', addAnother: 'إضافة مؤسسة أخرى',
      searchEstablishment: 'يمكنك الآن البحث عن هذه المؤسسة في Lewad.', adminAccessRequired: 'يلزم حساب مشرف نشط.',
    ...
    superSpace: {
      ...
      dashboard: {
        title: 'إحصائيات المنصة', text: 'عرض شامل لعمليات Lewad ضمن نطاق إدارتك.',
    ...
    system: {
      title: 'النظام', eyebrow: 'المشرف العام', intro: 'نظرة تحضيرية لوظائف Lewad الحساسة.',
    ...
    account: {
      ...
      profileSubtitle: 'حساب فريق Lewad الخاص بك كما هو مسجّل في قاعدة البيانات.',
