...
export const fr = {
  ...
  history: {
    title: 'Historique',
    subtitle: 'Tout ce que vous avez fait sur Lewad, du plus récent au plus ancien.',
    pointsNote: 'Chaque recherche réussie peut utiliser 1 point. Vous pouvez voir ici où vos points ont été utilisés ou ajoutés.',
    ...
    incomplete: 'Une partie de votre historique n’a pas pu être chargée. Réessayez dans un instant.',
    empty: 'Aucun historique pour le moment.',
    emptyText: 'Vos recherches, vos recharges et vos demandes apparaîtront ici.',
    showMore: 'Voir plus',
  ...
  appSearch: {
    ...
    demoNote: 'Ce nom proche vient de l’annuaire Lewad. Répondre « Oui » lance une nouvelle recherche.',
  },
  ...
  profileAvatar: {
    ...
    uploadFailed: 'Impossible d’envoyer l’image. Vérifiez le format ou réessayez.',
  ...
  settings: {
    ...
    passwordResetDescription: 'Nous vous enverrons un e-mail pour réinitialiser votre mot de passe.',
    ...
    resetEmailFailed: 'Impossible d’envoyer l’e-mail de réinitialisation pour le moment. Réessayez plus tard.',
  ...
  superAdminManagement: {
    ...
    subtitle: 'Gérez les comptes administrateur avec des actions contrôlées par le serveur.',
    ...
    migrationHint: 'Le module de gestion des admins n’est pas encore connecté à la base. Appliquez la migration Super Admin Admin Management.',
    accessDenied: 'Une session super admin active est requise pour accéder à ce module.',
    retry: 'Réessayer',
    ...
    suspendConfirm: 'Cet admin ne pourra plus utiliser les espaces d’administration tant qu’il est suspendu.',
    reactivateConfirm: 'Cet admin retrouvera l’accès à son espace opérationnel.',
    ...
    invitationHelp: 'Cette action enregistre une invitation en attente. Aucun compte Auth n’est créé depuis le navigateur.',
    ...
    auditSubtitle: 'Actions administratives enregistrées par la base de données.',
    auditActor: 'Par',
    auditTarget: 'Cible',
  ...
  businessSubmission: {
    ...
    subtitle: 'Soumettez votre établissement pour apparaitre dans les résultats de recherche Lewad.',
    introTitle: 'Comment ça marche ?',
    introText: 'Remplissez le formulaire ci-dessous. Notre équipe vérifiera votre demande et créera votre établissement sur Lewad. Vous serez contacté pour finaliser l\'inscription.',
    ...
    businessNameFrHint: 'Nom tel qu\'il apparaitra dans les résultats de recherche.',
    ...
    businessPhoneHint: 'Numéro public que les clients utiliseront pour vous contacter.',
    ...
    amountText: 'L\'inscription de votre établissement coûte {amount} pour {months} mois de publication. Le paiement est manuel : notre équipe vous contacte sur WhatsApp après vérification de votre demande.',
    periodSection: 'Durée de publication',
    periodMonthsValue: '{months} mois',
    submit: 'Soumettre la demande',
    submitting: 'Envoi en cours…',
    successTitle: 'Demande envoyée',
    successText: 'Votre demande a été enregistrée. Notre équipe l\'examinera dans les plus brefs délais.',
    ...
    rateLimit: 'Vous avez envoyé une demande récemment. Veuillez patienter avant de soumettre une nouvelle demande.',
    backendUnavailable: 'Le service de soumission n\'est pas encore activé. Réessayez plus tard.',
    ...
    errors: {
      ...
      ownerPhoneInvalid: 'Le numéro doit contenir exactement 8 chiffres et commencer par 2, 3 ou 4.',
      ...
      businessNameArInvalid: 'Le nom en arabe doit contenir uniquement des caractères arabes.',
      businessPhone: 'Veuillez saisir le numéro de téléphone de l\'établissement.',
      businessPhoneInvalid: 'Le numéro doit contenir exactement 8 chiffres et commencer par 2, 3 ou 4.',
      websiteInvalid: 'Veuillez saisir une URL valide commençant par http:// ou https://.',
