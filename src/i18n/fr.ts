...
export const fr = {
  ...
  nav: {
    ...
    navigate: "Navigation",
    activityEstimatedVisits: "visites estimées",
    activityEstimateHint: "Estimation basée sur l’activité récente",
    activityFallback: "Activité récente",
  ...
  appSearch: {
    ...
    chooseThisResult: "Choisir ce résultat",
    chooseMatchingResult:
      "Choisissez le résultat qui correspond à votre recherche.",
    searchQueryOnMap: "Rechercher « {query} » sur la carte",
    searchQueryOnMapHint:
      "Aucun résultat ne correspond exactement ? Cherchez le lieu lui-même sur la carte.",
    explicitMapNoResult:
      "Aucun résultat supplémentaire ne correspond sur la carte. Revenez aux résultats Lewad ou essayez une autre wilaya.",
    backToLewadResults: "Retour aux résultats Lewad",
    ...
    pagination: {
      ...
      of: "/",
      items: "résultats",
      navigation: "Pagination des résultats de recherche",
    },
    locationPrompt:
  ...
  superAdminServices: {
    ...
    subtitle:
      "Consultez et gérez toutes les fiches Lewad avec des actions protégées côté serveur.",
    add: "Ajouter",
    searchLabel: "Rechercher par nom",
    searchPlaceholder: "Nom en français ou en arabe…",
    filters: "Filtres",
    clearFilters: "Effacer les filtres",
    statusFilter: "Statut",
    typeFilter: "Type",
    scopeFilter: "Nature",
    verifiedFilter: "Vérification",
    sourceFilter: "Source",
    categoryFilter: "Catégorie",
    allStatuses: "Tous les statuts",
    allTypes: "Tous les types",
    allScopes: "Toutes les natures",
    allVerification: "Tous",
    allSources: "Toutes les sources",
    allCategories: "Toutes les catégories",
    verifiedOnly: "Vérifiés",
    unverifiedOnly: "Non vérifiés",
    pageSize: "Éléments par page",
    pageSize10: "10 par page",
    pageSize20: "20 par page",
    resultCount: "{count} établissements",
    loading: "Chargement des établissements…",
    emptyTitle: "Aucun établissement trouvé",
    emptyText: "Modifiez la recherche ou les filtres pour afficher d’autres résultats.",
    loadError: "Impossible de charger les établissements.",
    loadErrorHint: "Réessayez dans un instant.",
    moduleNotConnected: "Module non connecté",
    migrationHint:
      "La migration de gestion des services Super Admin doit être appliquée par le propriétaire.",
    accessDenied: "Une session super admin active est requise pour ce module.",
    serverError: "Erreur serveur",
    retry: "Réessayer",
    details: "Voir",
    edit: "Modifier",
    ...
    branchName: "Nom de l’agence principale",
    mainBranch: "Agence principale",
    coordinates: "Coordonnées",
    noCategory: "Sans catégorie",
    noLocation: "Non renseignée",
    noContact: "Non renseigné",
    noBranches: "Aucune agence enregistrée",
    branchPreview: "Aperçu limité à {shown} agences sur {total}.",
    statuses: {
      draft: "Brouillon",
      pending: "En attente",
      approved: "Approuvé",
    ...
    sources: {
      admin_created: "Création admin",
      client_submission: "Soumission client",
      map_discovery: "Découverte carte",
    ...
    detailsTitle: "Détails de l’établissement",
    detailsSubtitle: "Informations, origine et agences enregistrées.",
    detailsLoading: "Chargement des détails…",
    detailsError: "Impossible de charger ces détails.",
    addTitle: "Ajouter un établissement",
    addSubtitle: "Créez la fiche et, si renseignée, son agence principale.",
    editTitle: "Modifier l’établissement",
    editSubtitle: "Seuls les champs opérationnels sûrs sont modifiables ici.",
    nameRequired: "Le nom est obligatoire.",
    typeRequired: "Choisissez au moins un type.",
    createSuccess: "Établissement ajouté.",
    updateSuccess: "Établissement mis à jour.",
    archiveSuccess: "Établissement archivé.",
    reactivateSuccess: "Établissement réactivé.",
    actionError: "L’action n’a pas pu être effectuée.",
    archiveTitle: "Archiver cet établissement ?",
    archiveText:
      "La fiche sera suspendue et masquée des résultats publics, tout en conservant son historique et ses relations.",
    reactivateTitle: "Réactiver cet établissement ?",
    reactivateText: "La fiche redeviendra active selon les règles appliquées par le serveur.",
    verifiedHelp: "La vérification rend la fiche officiellement validée par l’équipe Lewad.",
    placeTypesHelp: "Les valeurs enregistrées restent des clés techniques stables, indépendantes de la langue.",
  },
  ...
  businessSubmission: {
    ...
    introText:
      "Renseignez les informations de votre établissement, choisissez son emplacement, puis ajoutez les informations de paiement. Vous pourrez ensuite contacter Lewad sur WhatsApp pour finaliser l'inscription.",
    stepsLabel: "Étapes",
    stepOne: "Étape 1",
    stepTwo: "Étape 2",
    stepThree: "Étape 3",
    ...
    branchCount: "Nombre d’agences",
    branchCountHint:
      "Si votre établissement a plusieurs agences, indiquez leur nombre. Sinon, conservez 1.",
    ...
    amountText:
      "L'inscription de votre établissement coûte {amount} pour {months} mois de publication. Le paiement est manuel et la finalisation se poursuit sur WhatsApp.",
    ...
    successText:
      "Votre demande a bien été reçue. Conservez son numéro et contactez Lewad sur WhatsApp pour finaliser l'inscription.",
    submissionId: "Numéro de la demande",
    pendingReview: "Demande reçue",
    ...
    errors: {
      ...
      requestedBranchCount:
        "Saisissez un nombre entier d’agences entre 1 et 20.",
      websiteInvalid:
