...
export const en: Dictionary = {
  ...
  history: {
    ...
    pointsNote: 'Each successful search may use 1 point. Here you can see where your points were used or added.',
    whereMyPoints: 'Where did my points go?',
    refresh: 'Refresh',
    loading: 'Loading your history…',
    unavailable: 'Your history is temporarily unavailable.',
    incomplete: 'Part of your history could not be loaded. Try again in a moment.',
  ...
  appSearch: {
    ...
    demoNote: 'This close match comes from the Lewad directory. Choosing “Yes” starts a new search.',
  },
  ...
  businessSubmission: {
    ...
    amountText: 'Listing your business costs {amount} for {months} months. Payment is manual: our team contacts you on WhatsApp once your submission has been reviewed.',
